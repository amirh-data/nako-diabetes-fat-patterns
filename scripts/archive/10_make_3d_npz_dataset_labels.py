...
OUTPUT_DIR = Path(
    "/mnt/qdata/projects/StudentsMarius/194_preds/studhaget1/encoder_3d_dataset/npz_96_balanced_t2d_3000_labels"
)
...
def main():
    ...
    for i, row in df.iterrows():
        ...
        # Preserve Dataset301 label information instead of binary foreground mask
