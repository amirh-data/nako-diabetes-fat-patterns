...
MODEL_PATH = Path(
    "/mnt/qdata/projects/StudentsMarius/194_preds/studhaget1/encoder_3d_dataset/checkpoints_t2d_3000/cnn3d_mlp_final.pt"
)
...
def main():
    ...
    emb_cols = [f"img_emb_{i}" for i in range(embeddings.shape[1])]
