...
FEATURE_CSV = Path(
    "/mnt/qdata/projects/StudentsMarius/194_preds/studhaget1/regional_pixel_features/regional_features_wholebody128_balanced_t2d_3000.csv"
)
...
def main():
    ...
    out_path = OUT_DIR / "regional_wholebody128_balanced_t2d_classifier_results.csv"
